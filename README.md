...
루트 4페이지(`index.html` · `run.html` · `privacy.html` · `terms.html`)와 그것을
5개 언어로 프리렌더한 20페이지, 합쳐서 24페이지다. 빌드는 Node 스크립트 두 개뿐이다.
...
9. 신뢰 블록이 인용하는 앱 숫자(테스트 506 · 번역표 396 · 지표 설명 40)가
   `tools/app-facts.json`과 같은가. 화면 문구 개수와 큐 개수는 **하한 표기**라
